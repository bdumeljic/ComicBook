...
public class Douglas_Peucker_Algorithm {
     ...
     */
    public static ArrayList<Point> reduceWithTolerance(ArrayList<Point> shape,
                                                          double tolerance)
    {
        int n = shape.size();
     ...
     *            this line segment
     */
    private static void douglasPeuckerReduction(ArrayList<Point> shape, boolean[] marked,
